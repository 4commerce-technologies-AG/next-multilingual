 ...
 */
export declare function getPagesDirectoryPath(filesystemPath: string): string;
/**
 ...
 */
export declare function removePagesDirectoryPath(filesystemPath: string): string;
/**
