 ...
 */
export declare function useLocalizedUrl(url: Url, locale?: string | undefined, absolute?: boolean, includeBasePath?: boolean): string;
/**
 ...
 * @returns The localized URL path when available, otherwise fallback to a standard non-localized Next.js URL.
 */
export declare function getLocalizedUrl(url: Url, locale: string, absolute?: boolean): string;
