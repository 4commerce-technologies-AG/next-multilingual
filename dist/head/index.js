...
function Head(_a) {
    ...
    var rewrites = (0, use_rewrites_1.useRewrites)(); // Setting a variable here since React hooks can't be used in a callback.
    ...
    return ((0, jsx_runtime_1.jsxs)(head_1.default, { children: [(0, jsx_runtime_1.jsx)("link", { rel: "canonical", href: (0, get_localized_url_from_rewrites_1.getLocalizedUrlFromRewrites)(rewrites, { pathname: pathname, query: query }, actualLocale, true, basePath) }, "canonical-link"), actualLocales === null || actualLocales === void 0 ? void 0 : actualLocales.map(function (actualLocale) {
                return ((0, jsx_runtime_1.jsx)("link", { rel: "alternate", href: (0, get_localized_url_from_rewrites_1.getLocalizedUrlFromRewrites)(rewrites, { pathname: pathname, query: query }, actualLocale, true, basePath), hrefLang: (0, __1.normalizeLocale)(actualLocale) }, "alternate-link-".concat(actualLocale)));
            }), children] }));
}
