...
const use_rewrites_1 = require("../hooks/use-rewrites");
/**
...
function Head({ children }) {
    ...
    const rewrites = (0, use_rewrites_1.useRewrites)(); // Setting a variable here since React hooks can't be used in a callback.
    ...
    return ((0, jsx_runtime_1.jsxs)(head_1.default, { children: [(0, jsx_runtime_1.jsx)("link", { rel: "canonical", href: (0, get_localized_url_1.getLocalizedUrl)(rewrites, { pathname, query }, actualDefaultLocale, basePath, true) }, "canonical-link"), actualLocales.map((actualLocale) => {
                return ((0, jsx_runtime_1.jsx)("link", { rel: "alternate", href: (0, get_localized_url_1.getLocalizedUrl)(rewrites, { pathname, query }, actualLocale, basePath, true), hrefLang: (0, __1.normalizeLocale)(actualLocale) }, `alternate-link-${actualLocale}`));
            }), children] }, void 0));
}
