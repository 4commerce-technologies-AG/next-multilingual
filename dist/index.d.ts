 ...
 */
export declare function getPreferredLocale(acceptLanguageHeader: string, actualLocales: string[], actualDefaultLocale: string): string;
/**
 ...
 */
export declare function getCookieLocale(serverSidePropsContext: GetServerSidePropsContext<ParsedUrlQuery, PreviewData>, actualLocales: string[]): string;
/**
 ...
 */
export declare function hydrateQueryParameters(path: string, parsedUrlQuery: ParsedUrlQuery, suppressWarning?: boolean): string;
/**
